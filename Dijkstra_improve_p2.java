/**
 * Improve the third question. Multipath heap
 * Use a faster priority queue. There is some room for optimization in the
 * supplied priority queue. You could also consider using a multiway heap as in
 * Sedgewick Program 20.10.
 */
import java.awt.Color;

public class Dijkstra_improve_p2 {
    ...
    public Dijkstra_improve_p2(EuclideanGraph G, int way) {
    ...
    public void dijkstra(int s, int d, int draw) {
        ...
        // priority queue
        IndexMultiwayMinPQ pq = new IndexMultiwayMinPQ(V, way);
